...
export declare const OHLCVCandleSchema: z.ZodEffects<
  z.ZodEffects<
    z.ZodEffects<
      z.ZodObject<
        {
...
export declare const IndicatorNameSchema: z.ZodEnum<
  ['ema_20', 'ema_50', 'ema_200', 'rsi_14', 'macd', 'bollinger_bands', 'volume_sma']
>;
    ...
    payload: z.ZodObject<
      {
        ...
        activeSubscriptions: z.ZodArray<
          z.ZodObject<
            {
              symbol: z.ZodString;
              interval: z.ZodEnum<['1m', '5m', '15m', '30m', '1h', '4h', '1d', '1w']>;
...
>;
export declare const ServerMessageSchema: z.ZodDiscriminatedUnion<
  'type',
  [
    z.ZodObject<
      {
...
>;
export declare const GetCandlesRequestSchema: z.ZodEffects<
  z.ZodObject<
    {
      provider: z.ZodEnum<['binance', 'coinbase', 'mock']>;
      symbol: z.ZodString;
...
>;
export declare const CalculateIndicatorsRequestSchema: z.ZodEffects<
  z.ZodObject<
    {
      provider: z.ZodEnum<['binance', 'coinbase', 'mock']>;
      symbol: z.ZodString;
...
>;
export declare const GenerateSignalsRequestSchema: z.ZodEffects<
  z.ZodObject<
    {
      provider: z.ZodEnum<['binance', 'coinbase', 'mock']>;
      symbol: z.ZodString;
        ...
        binance: z.ZodObject<
          {
            enabled: z.ZodBoolean;
            symbols: z.ZodArray<z.ZodString, 'many'>;
            intervals: z.ZodArray<
              z.ZodEnum<['1m', '5m', '15m', '30m', '1h', '4h', '1d', '1w']>,
              'many'
            >;
            backfillOnStartup: z.ZodBoolean;
          },
...
>;
export declare const BackfillRequestSchema: z.ZodEffects<
  z.ZodEffects<
    z.ZodObject<
      {
        provider: z.ZodEnum<['binance', 'coinbase', 'mock']>;
